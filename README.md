...
| [Loom](https://github.com/alavesa/loom) | Serves a design system — tokens, components, usage rules — as queryable context for AI, over MCP or the command line. Same engine, two surfaces: `serve` speaks MCP, `query` returns the same slices from a shell. |
