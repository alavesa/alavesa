...
| [RedSketch](https://github.com/alavesa/RedSketch) | Threat-model your Figma designs before writing code. Drop a Figma URL → STRIDE threats, 35 pattern matches, compliance gaps across 19 regulations. [npm](https://www.npmjs.com/package/redsketch) · [uxsec.dev/redsketch](https://uxsec.dev/redsketch) |
